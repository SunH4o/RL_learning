...
class QLearningAgent(object):
    def __init__(self) :
        ...
        self.discount_factor = 0.8 #折扣因子
        self.epsilon = 0.2         #贪心率
        self.q_table = q_table #frozenlake有16个state，4个action

    def learn(self,action,state,reward,next_state,next_action):
        current_q = self.q_table[state,action]
        #sarsa更新:on-policy,对比Qlearning
...
if __name__ == "__main__":
    ...
    for _ in range(episode):    
        ...
        while True:
            ...
            agent.learn(action,state,reward,next_state,next_action)
            #修改q值，加快收敛
